...
type PostRepository interface {
	...
	GetRandomFromAllTables(guildID string, count int) ([]model.Post, error)
	GetRandomFromAllTablesByTag(guildID string, tagID string, count int, excludeTags []string) ([]model.Post, error)
...
type PunishmentRepository interface {
	...
	GetRecentPunishments(guildID string, limit int) ([]model.PunishmentRecord, error)
}
